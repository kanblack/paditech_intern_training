    ...
    private void toolbarButtonAction() {
        ...
        mainActivity.icon_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mainActivity.drawBitmap(editable_img_screen51.canvasView.getMbitmap());
    ...
    private void start() {
        ...
        if (mainActivity.getBitmap() != null) {
            final Thread thread = new Thread(new Runnable() {
                @Override
                public void run() {
                    while (editable_img_screen51.canvasView.width == 0) {
                        try {
                            Thread.sleep(500);
                    ...
                    mainActivity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            editable_img_screen51.canvasView.screen5DrawFrame(mainActivity.getBitmap());
                        }
                    });
                }
            });
